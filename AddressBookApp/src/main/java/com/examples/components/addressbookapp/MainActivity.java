package com.examples.components.addressbookapp;
...
import com.examples.components.addressbookapp.utils.DBTools;
...
public class MainActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (contactList.size() != 0) {
            ...
            String[] from = {"contactId", "lastName", "firstName"};
            int[] to = {R.id.contactId, R.id.lastName, R.id.firstName};
            ListAdapter adapter = new SimpleAdapter(MainActivity.this, contactList, R.layout.contact_entry, from, to);
