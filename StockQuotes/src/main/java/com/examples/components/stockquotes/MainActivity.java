package com.examples.components.stockquotes;
...
import com.examples.components.stockquotes.models.StockInfoActivity_XML_Dom_Manipulation;
import com.examples.components.stockquotes.models.StockInfoActivity_XML_PullParser;
...
public class MainActivity extends Activity {
    ...
    public final static String STOCK_SYMBOL = "com.examples.components.stockquotes.STOCK";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // can be used with a pipe symbol - MODE_WORLD_READABLE | MODE_WORLD_WRITABLE
    ...
    private void insertStockInScrollView(String stock, int arrayIndex){
        ...
        //
        // TODO: Important! how to add a dynamic component to a layout
        //
    ...
    public OnClickListener enterStockButtonListener = new OnClickListener(){
        ...
        public void onClick(View theView) {
            ...
            if (stockSymbolEditText.getText().length() > 0) {
                ...
                //
                // TODO: Important ! How to force the keyboard to close
                //
                InputMethodManager imm = (InputMethodManager) getSystemService(
                        Context.INPUT_METHOD_SERVICE);
                // This is the component that forced the keyboard to open
                imm.hideSoftInputFromWindow(stockSymbolEditText.getWindowToken(), 0);
            } else {

                //
                // TODO: Important! How to create an alert button
                //
    ...
    public OnClickListener getStockFromWebsiteListener = new OnClickListener(){
        public void onClick(View v) {
            ...
            //
            // TODO: Important! How to open a web-browser from the application
            //
    ...
    public OnClickListener getStockActivityListener = new OnClickListener(){
        public void onClick(View v) {
            //
            // TODO: Important! Get dynamically the parent of the components (Button) in order to address different components under it
            //
            ...
            //
            // TODO: Important ! Intent usage - An intent is an object that can be used to start another activity
            //
            Intent intent = new Intent(MainActivity.this, StockInfoActivity_XML_PullParser.class);
//            Intent intent = new Intent(MainActivity.this, StockInfoActivity_XML_Dom_Manipulation.class);
